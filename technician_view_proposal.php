<?php
session_start();
if (!isset($_SESSION['role']) || ($_SESSION['role'] !== 'technician' && $_SESSION['role'] !== 'technician')) {
...
if (!$row) {
    header("Location: technician_proposal.php"); exit;
}
...
if (isset($_GET['delete_comment'])) {
    ...
    $stmt->execute();
    $stmt->close();
    header("Location: technician_view_proposal.php?id=$id&tab=comments");
    exit;
}
...
if (isset($_GET['delete_note'])) {
    ...
    $stmt->execute();
    $stmt->close();
    header("Location: technician_view_proposal.php?id=$id&tab=notes");
    exit;
}
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <div class="comment-item">
                                                <div class="d-flex justify-content-between align-items-start mb-2">
                                                    <div>
                                                        <span class="fw-semibold"><?= $c['role'] === 'technician' ? 'Technician' : htmlspecialchars($c['full_name'] ?? 'Unknown') ?></span>
