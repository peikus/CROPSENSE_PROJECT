...
if (isset($_GET['delete'])) {
    ...
    $stmt->execute();
    $stmt->close();
    header("Location: technician_proposal.php");
    exit;
}
?>
...
<title>RiceGuard AI • Technician Proposals</title>
        ...
        <div class="page-main-header">
            <div class="d-flex justify-content-between">
                <div class="page-title-section">
                    <h4 class="m-0 text-white"><i class="fas fa-file-invoice me-2"></i>Technician Proposals</h4>
                                </div>
                <div class="d-flex align-items-center">
                    <a href="technician_create_proposal.php" class="btn btn-primary btn-rounded">
...
// Technician: Own proposals (all types) + Public proposals
    ...
    <span class="status-badge <?= $statusClass ?>">
        <?= htmlspecialchars($statusLabel) ?>
            ...
            <div class="d-flex justify-content-center align-items-center gap-2">
                <!-- View button -->
                <a href="technician_view_proposal.php?id=<?= $row['id'] ?>" 
                ...
                <div class="dropdown-container" data-proposal-id="<?= $row['id'] ?>">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="technician_edit_proposal.php?id=<?= $row['id'] ?>" class="dropdown-item">
        ...
        document.addEventListener('click', function(e) {
            ...
            if (e.target.matches('.delete-btn, .delete-btn *')) {
                ...
                if (confirm(`Delete proposal #${id} permanently?\nThis action cannot be undone.`)) {
                    window.location.href = `technician_proposal.php?delete=${id}`;
                }
                closeAllDropdowns();
            }
        });
